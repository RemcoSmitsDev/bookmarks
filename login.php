    ...
    <section class="px-4 mt-32 md:mt-56 space-y-6 container mx-auto max-w-lg">
        ...
        <form class="flex flex-col space-y-4" action="login" method="POST">
            <input class="px-4 py-2 border outline-none rounded appearance-none" type="text" name="email"
                placeholder="Email" value="<?php if(isset($_COOKIE['email'])){echo $_COOKIE['email']; } ?>" required>
            ...
            <a class="text-sm leading-relaxed text-center" href="register">If you don't have an account? Make one
                now</a>
        </form>
    </section>
