...
<body class="antialiased">
    ...
    <nav id="nav"
        class="relative py-6 px-4 w-full md:flex md:items-center md:justify-between container mx-auto max-w-screen-xl z-auto">
    ...
    <section class="space-y-6 px-4 mt-32 md:mt-56 container mx-auto max-w-lg">
        ...
        <form class="space-y-4 flex flex-col" action="register" method="post">
            <input class="px-4 py-2 border outline-none rounded appearance-none" type="text" name="first_name"
                placeholder="First name" required>
            <input class="px-4 py-2 border outline-none rounded appearance-none" type="text" name="last_name"
                placeholder="Last name" required>
            <input class="px-4 py-2 border outline-none rounded appearance-none" type="text" name="email"
                placeholder="Email" required>
            <input class="px-4 py-2 border outline-none rounded appearance-none" type="password" name="password"
